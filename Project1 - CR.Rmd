...
In this model, $\mu$ represnets the average first-grade math test-score for studnets enrolled in regular classes. $T_2$ represents the average change in score for studnets enrolled in 
