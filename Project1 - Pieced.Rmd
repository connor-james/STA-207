...
$$MathScore = \mu_{i.} +T_2X_2 + T_3X_3 + \epsilon_{i,j} $$
where:
...
```{r , echo=FALSE, fig.align="center"}
hist(reg1$residuals, main = "Historgram of Residuals")
```
